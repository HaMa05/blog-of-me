...
import require$$0, { getCurrentInstance, reactive, isRef, ref, onBeforeMount, onUnmounted, onServerPrefetch, unref, toRef, defineComponent, computed, h, resolveComponent, defineAsyncComponent, watchEffect, markRaw, inject, provide, Suspense, Transition, useSSRContext, mergeProps, toRefs, Text, watch, useSlots, withCtx, createVNode, toDisplayString as toDisplayString$1, withAsyncContext, createTextVNode, shallowRef, onErrorCaptured, createApp, renderSlot, openBlock, createBlock, Fragment as Fragment$1, renderList } from "vue";
...
const _sfc_main$B = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<ul${ssrRenderAttrs(mergeProps({ class: "prev-next-cont" }, _attrs))} data-v-a2ea3416><li class="link-item prev" data-v-a2ea3416>`);
      if (__props.prev) {
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span data-v-a2ea3416${_scopeId}>${ssrInterpolate(__props.prev.title)}</span>`);
            } else {
              return [
      ...
      if (__props.next) {
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span data-v-a2ea3416${_scopeId}>${ssrInterpolate(__props.next.title)}</span>`);
...
const ____slug__vue_vue_type_style_index_0_scoped_true_lang = /* @__PURE__ */ (() => '\n.article-main[data-v-49ab34c5] {\n\n    margin: auto;\n\n    max-width: 64rem;\n\n    padding: 1rem;\n}\n.article-header[data-v-49ab34c5] {\n\n    padding: 1rem;\n\n    padding-bottom: 3rem;\n}\n.article-header .heading[data-v-49ab34c5] {\n\n    font-size: 3rem;\n\n    line-height: 1;\n\n    font-weight: 800;\n}\n.article-header .supporting[data-v-49ab34c5] {\n\n    font-size: 1.125rem;\n\n    line-height: 1.75rem;\n\n    font-weight: 500;\n}\n.article-section[data-v-49ab34c5] {\n\n    display: grid;\n\n    grid-template-columns: repeat(8, minmax(0, 1fr));\n}\n.aside[data-v-49ab34c5] {\n\n    grid-column: 1 / -1;\n\n    grid-row-start: 1;\n\n    width: 100%;\n\n    padding-top: 3.5rem;\n}\n@media (min-width: 768px) {\n.aside[data-v-49ab34c5] {\n\n        grid-column: span 2 / span 2;\n}\n}\n.aside .toc[data-v-49ab34c5] {\n\n    position: -webkit-sticky;\n\n    position: sticky;\n\n    top: 5rem;\n}\n.article[data-v-49ab34c5] {\n\n    color: var(--tw-prose-body);\n\n    max-width: 65ch;\n}\n.article[data-v-49ab34c5] :where([class~="lead"]):not(:where([class~="not-prose"] *)) {\n\n    color: var(--tw-prose-lead);\n\n    font-size: 1.25em;\n\n    line-height: 1.6;\n\n    margin-top: 1.2em;\n\n    margin-bottom: 1.2em;\n}\n.article[data-v-49ab34c5] :where(a):not(:where([class~="not-prose"] *)) {\n\n    color: var(--tw-prose-links);\n\n    text-decoration: underline;\n\n    font-weight: 500;\n}\n.article[data-v-49ab34c5] :where(strong):not(:where([class~="not-prose"] *)) {\n\n    color: var(--tw-prose-bold);\n\n    font-weight: 600;\n}\n.article[data-v-49ab34c5] :where(ol):not(:where([class~="not-prose"] *)) {\n\n    list-style-type: decimal;\n\n    padding-left: 1.625em;\n}\n.article[data-v-49ab34c5] :where(ol[type="A"]):not(:where([class~="not-prose"] *)) {\n\n    list-style-type: upper-alpha;\n}\n.article[data-v-49ab34c5] :where(ol[type="a"]):not(:where([class~="not-prose"] *)) {\n\n    list-style-type: lower-alpha;\n}\n.article[data-v-49ab34c5] :where(ol[type="A" s]):not(:where([class~="not-prose"] *)) {\n\n    list-style-type: upper-alpha;\n}\n.article[data-v-49ab34c5] :where(ol[type="a" s]):not(:where([class~="not-prose"] *)) {\n\n    list-style-type: lower-alpha;\n}\n.article[data-v-49ab34c5] :where(ol[type="I"]):not(:where([class~="not-prose"] *)) {\n\n    list-style-type: upper-roman;\n}\n.article[data-v-49ab34c5] :where(ol[type="i"]):not(:where([class~="not-prose"] *)) {\n\n    list-style-type: lower-roman;\n}\n.article[data-v-49ab34c5] :where(ol[type="I" s]):not(:where([class~="not-prose"] *)) {\n\n    list-style-type: upper-roman;\n}\n.article[data-v-49ab34c5] :where(ol[type="i" s]):not(:where([class~="not-prose"] *)) {\n\n    list-style-type: lower-roman;\n}\n.article[data-v-49ab34c5] :where(ol[type="1"]):not(:where([class~="not-prose"] *)) {\n\n    list-style-type: decimal;\n}\n.article[data-v-49ab34c5] :where(ul):not(:where([class~="not-prose"] *)) {\n\n    list-style-type: disc;\n\n    padding-left: 1.625em;\n}\n.article[data-v-49ab34c5] :where(ol > li):not(:where([class~="not-prose"] *))::marker {\n\n    font-weight: 400;\n\n    color: var(--tw-prose-counters);\n}\n.article[data-v-49ab34c5] :where(ul > li):not(:where([class~="not-prose"] *))::marker {\n\n    color: var(--tw-prose-bullets);\n}\n.article[data-v-49ab34c5] :where(hr):not(:where([class~="not-prose"] *)) {\n\n    border-color: var(--tw-prose-hr);\n\n    border-top-width: 1px;\n\n    margin-top: 3em;\n\n    margin-bottom: 3em;\n}\n.article[data-v-49ab34c5] :where(blockquote):not(:where([class~="not-prose"] *)) {\n\n    font-weight: 500;\n\n    font-style: italic;\n\n    color: var(--tw-prose-quotes);\n\n    border-left-width: 0.25rem;\n\n    border-left-color: var(--tw-prose-quote-borders);\n\n    quotes: "\\201C""\\201D""\\2018""\\2019";\n\n    margin-top: 1.6em;\n\n    margin-bottom: 1.6em;\n\n    padding-left: 1em;\n}\n.article[data-v-49ab34c5] :where(blockquote p:first-of-type):not(:where([class~="not-prose"] *))::before {\n\n    content: open-quote;\n}\n.article[data-v-49ab34c5] :where(blockquote p:last-of-type):not(:where([class~="not-prose"] *))::after {\n\n    content: close-quote;\n}\n.article[data-v-49ab34c5] :where(h1):not(:where([class~="not-prose"] *)) {\n\n    color: var(--tw-prose-headings);\n\n    font-weight: 800;\n\n    font-size: 2.25em;\n\n    margin-top: 0;\n\n    margin-bottom: 0.8888889em;\n\n    line-height: 1.1111111;\n}\n.article[data-v-49ab34c5] :where(h1 strong):not(:where([class~="not-prose"] *)) {\n\n    font-weight: 900;\n}\n.article[data-v-49ab34c5] :where(h2):not(:where([class~="not-prose"] *)) {\n\n    color: var(--tw-prose-headings);\n\n    font-weight: 700;\n\n    font-size: 1.5em;\n\n    margin-top: 2em;\n\n    margin-bottom: 1em;\n\n    line-height: 1.3333333;\n}\n.article[data-v-49ab34c5] :where(h2 strong):not(:where([class~="not-prose"] *)) {\n\n    font-weight: 800;\n}\n.article[data-v-49ab34c5] :where(h3):not(:where([class~="not-prose"] *)) {\n\n    color: var(--tw-prose-headings);\n\n    font-weight: 600;\n\n    font-size: 1.25em;\n\n    margin-top: 1.6em;\n\n    margin-bottom: 0.6em;\n\n    line-height: 1.6;\n}\n.article[data-v-49ab34c5] :where(h3 strong):not(:where([class~="not-prose"] *)) {\n\n    font-weight: 700;\n}\n.article[data-v-49ab34c5] :where(h4):not(:where([class~="not-prose"] *)) {\n\n    color: var(--tw-prose-headings);\n\n    font-weight: 600;\n\n    margin-top: 1.5em;\n\n    margin-bottom: 0.5em;\n\n    line-height: 1.5;\n}\n.article[data-v-49ab34c5] :where(h4 strong):not(:where([class~="not-prose"] *)) {\n\n    font-weight: 700;\n}\n.article[data-v-49ab34c5] :where(figure > *):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 0;\n\n    margin-bottom: 0;\n}\n.article[data-v-49ab34c5] :where(figcaption):not(:where([class~="not-prose"] *)) {\n\n    color: var(--tw-prose-captions);\n\n    font-size: 0.875em;\n\n    line-height: 1.4285714;\n\n    margin-top: 0.8571429em;\n}\n.article[data-v-49ab34c5] :where(code):not(:where([class~="not-prose"] *)) {\n\n    color: var(--tw-prose-code);\n\n    font-weight: 600;\n\n    font-size: 0.875em;\n}\n.article[data-v-49ab34c5] :where(code):not(:where([class~="not-prose"] *))::before {\n\n    content: "`";\n}\n.article[data-v-49ab34c5] :where(code):not(:where([class~="not-prose"] *))::after {\n\n    content: "`";\n}\n.article[data-v-49ab34c5] :where(a code):not(:where([class~="not-prose"] *)) {\n\n    color: var(--tw-prose-links);\n}\n.article[data-v-49ab34c5] :where(pre):not(:where([class~="not-prose"] *)) {\n\n    color: var(--tw-prose-pre-code);\n\n    background-color: var(--tw-prose-pre-bg);\n\n    overflow-x: auto;\n\n    font-weight: 400;\n\n    font-size: 0.875em;\n\n    line-height: 1.7142857;\n\n    margin-top: 1.7142857em;\n\n    margin-bottom: 1.7142857em;\n\n    border-radius: 0.375rem;\n\n    padding-top: 0.8571429em;\n\n    padding-right: 1.1428571em;\n\n    padding-bottom: 0.8571429em;\n\n    padding-left: 1.1428571em;\n}\n.article[data-v-49ab34c5] :where(pre code):not(:where([class~="not-prose"] *)) {\n\n    background-color: transparent;\n\n    border-width: 0;\n\n    border-radius: 0;\n\n    padding: 0;\n\n    font-weight: inherit;\n\n    color: inherit;\n\n    font-size: inherit;\n\n    font-family: inherit;\n\n    line-height: inherit;\n}\n.article[data-v-49ab34c5] :where(pre code):not(:where([class~="not-prose"] *))::before {\n\n    content: none;\n}\n.article[data-v-49ab34c5] :where(pre code):not(:where([class~="not-prose"] *))::after {\n\n    content: none;\n}\n.article[data-v-49ab34c5] :where(table):not(:where([class~="not-prose"] *)) {\n\n    width: 100%;\n\n    table-layout: auto;\n\n    text-align: left;\n\n    margin-top: 2em;\n\n    margin-bottom: 2em;\n\n    font-size: 0.875em;\n\n    line-height: 1.7142857;\n}\n.article[data-v-49ab34c5] :where(thead):not(:where([class~="not-prose"] *)) {\n\n    border-bottom-width: 1px;\n\n    border-bottom-color: var(--tw-prose-th-borders);\n}\n.article[data-v-49ab34c5] :where(thead th):not(:where([class~="not-prose"] *)) {\n\n    color: var(--tw-prose-headings);\n\n    font-weight: 600;\n\n    vertical-align: bottom;\n\n    padding-right: 0.5714286em;\n\n    padding-bottom: 0.5714286em;\n\n    padding-left: 0.5714286em;\n}\n.article[data-v-49ab34c5] :where(tbody tr):not(:where([class~="not-prose"] *)) {\n\n    border-bottom-width: 1px;\n\n    border-bottom-color: var(--tw-prose-td-borders);\n}\n.article[data-v-49ab34c5] :where(tbody tr:last-child):not(:where([class~="not-prose"] *)) {\n\n    border-bottom-width: 0;\n}\n.article[data-v-49ab34c5] :where(tbody td):not(:where([class~="not-prose"] *)) {\n\n    vertical-align: baseline;\n\n    padding-top: 0.5714286em;\n\n    padding-right: 0.5714286em;\n\n    padding-bottom: 0.5714286em;\n\n    padding-left: 0.5714286em;\n}\n.article[data-v-49ab34c5] {\n\n    --tw-prose-body: #374151;\n\n    --tw-prose-headings: #111827;\n\n    --tw-prose-lead: #4b5563;\n\n    --tw-prose-links: #111827;\n\n    --tw-prose-bold: #111827;\n\n    --tw-prose-counters: #6b7280;\n\n    --tw-prose-bullets: #d1d5db;\n\n    --tw-prose-hr: #e5e7eb;\n\n    --tw-prose-quotes: #111827;\n\n    --tw-prose-quote-borders: #e5e7eb;\n\n    --tw-prose-captions: #6b7280;\n\n    --tw-prose-code: #111827;\n\n    --tw-prose-pre-code: #e5e7eb;\n\n    --tw-prose-pre-bg: #1f2937;\n\n    --tw-prose-th-borders: #d1d5db;\n\n    --tw-prose-td-borders: #e5e7eb;\n\n    --tw-prose-invert-body: #d1d5db;\n\n    --tw-prose-invert-headings: #fff;\n\n    --tw-prose-invert-lead: #9ca3af;\n\n    --tw-prose-invert-links: #fff;\n\n    --tw-prose-invert-bold: #fff;\n\n    --tw-prose-invert-counters: #9ca3af;\n\n    --tw-prose-invert-bullets: #4b5563;\n\n    --tw-prose-invert-hr: #374151;\n\n    --tw-prose-invert-quotes: #f3f4f6;\n\n    --tw-prose-invert-quote-borders: #374151;\n\n    --tw-prose-invert-captions: #9ca3af;\n\n    --tw-prose-invert-code: #fff;\n\n    --tw-prose-invert-pre-code: #d1d5db;\n\n    --tw-prose-invert-pre-bg: rgb(0 0 0 / 50%);\n\n    --tw-prose-invert-th-borders: #4b5563;\n\n    --tw-prose-invert-td-borders: #374151;\n\n    font-size: 1rem;\n\n    line-height: 1.75;\n}\n.article[data-v-49ab34c5] :where(p):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 1.25em;\n\n    margin-bottom: 1.25em;\n}\n.article[data-v-49ab34c5] :where(img):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 2em;\n\n    margin-bottom: 2em;\n}\n.article[data-v-49ab34c5] :where(video):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 2em;\n\n    margin-bottom: 2em;\n}\n.article[data-v-49ab34c5] :where(figure):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 2em;\n\n    margin-bottom: 2em;\n}\n.article[data-v-49ab34c5] :where(h2 code):not(:where([class~="not-prose"] *)) {\n\n    font-size: 0.875em;\n}\n.article[data-v-49ab34c5] :where(h3 code):not(:where([class~="not-prose"] *)) {\n\n    font-size: 0.9em;\n}\n.article[data-v-49ab34c5] :where(li):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 0.5em;\n\n    margin-bottom: 0.5em;\n}\n.article[data-v-49ab34c5] :where(ol > li):not(:where([class~="not-prose"] *)) {\n\n    padding-left: 0.375em;\n}\n.article[data-v-49ab34c5] :where(ul > li):not(:where([class~="not-prose"] *)) {\n\n    padding-left: 0.375em;\n}\n.article[data-v-49ab34c5] > :where(ul > li p):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 0.75em;\n\n    margin-bottom: 0.75em;\n}\n.article[data-v-49ab34c5] > :where(ul > li > *:first-child):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 1.25em;\n}\n.article[data-v-49ab34c5] > :where(ul > li > *:last-child):not(:where([class~="not-prose"] *)) {\n\n    margin-bottom: 1.25em;\n}\n.article[data-v-49ab34c5] > :where(ol > li > *:first-child):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 1.25em;\n}\n.article[data-v-49ab34c5] > :where(ol > li > *:last-child):not(:where([class~="not-prose"] *)) {\n\n    margin-bottom: 1.25em;\n}\n.article[data-v-49ab34c5] :where(ul ul, ul ol, ol ul, ol ol):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 0.75em;\n\n    margin-bottom: 0.75em;\n}\n.article[data-v-49ab34c5] :where(hr + *):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 0;\n}\n.article[data-v-49ab34c5] :where(h2 + *):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 0;\n}\n.article[data-v-49ab34c5] :where(h3 + *):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 0;\n}\n.article[data-v-49ab34c5] :where(h4 + *):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 0;\n}\n.article[data-v-49ab34c5] :where(thead th:first-child):not(:where([class~="not-prose"] *)) {\n\n    padding-left: 0;\n}\n.article[data-v-49ab34c5] :where(thead th:last-child):not(:where([class~="not-prose"] *)) {\n\n    padding-right: 0;\n}\n.article[data-v-49ab34c5] :where(tbody td:first-child):not(:where([class~="not-prose"] *)) {\n\n    padding-left: 0;\n}\n.article[data-v-49ab34c5] :where(tbody td:last-child):not(:where([class~="not-prose"] *)) {\n\n    padding-right: 0;\n}\n.article[data-v-49ab34c5] > :where(:first-child):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 0;\n}\n.article[data-v-49ab34c5] > :where(:last-child):not(:where([class~="not-prose"] *)) {\n\n    margin-bottom: 0;\n}\n.article[data-v-49ab34c5] {\n\n    grid-column: 1 / -1;\n\n    margin: auto;\n\n    width: 100%;\n\n    max-width: 48rem;\n\n    padding: 1rem;\n}\n@media (min-width: 768px) {\n.article[data-v-49ab34c5] {\n\n        grid-column: span 6 / span 6;\n\n        grid-column-start: 1;\n\n        grid-row-start: 1;\n}\n}\n')();
const meta$3 = void 0;
const Tags_vue_vue_type_style_index_0_scoped_true_lang = /* @__PURE__ */ (() => "\n/* ... */\n.tag-list[data-v-ca42e06e] {\n    display: flex;\n    align-items: center;\n    gap: 0.5rem;\n    border-radius: 0.5rem;\n    border-width: 1px;\n    border-color: transparent;\n    padding: 0.5rem\n}\n.tag-list.active[data-v-ca42e06e] {\n    --tw-border-opacity: 1;\n    border-color: rgb(226 232 240 / var(--tw-border-opacity))\n}\n.article-tags[data-v-ca42e06e] {\n    max-width: 0rem;\n    overflow: hidden;\n    transition-property: all;\n    transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1);\n    transition-duration: 150ms\n}\n.article-tags.expanded[data-v-ca42e06e] {\n    max-width: 100%\n}\n")();
const _sfc_main$A = {
  __name: "Tags",
  __ssrInlineRender: true,
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<span data-v-ca42e06e>Tags</span></button><ul class="${ssrRenderClass([{ expanded: expanded.value }, "article-tags"])}" data-v-ca42e06e><!--[-->`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderSuspense(_push, {
        default: () => {
          if (unref(error)) {
            _push(ssrRenderComponent(unref(_sfc_main$w), { error: unref(error) }, null, _parent));
          } else {
...
const SiteHeader_vue_vue_type_style_index_0_scoped_true_lang = /* @__PURE__ */ (() => "\n.site-header[data-v-68c30f52] {\n\n    position: -webkit-sticky;\n\n    position: sticky;\n\n    top: 0px;\n\n    z-index: 20;\n\n    width: 100%;\n\n    border-bottom-width: 2px;\n\n    border-color: rgb(255 255 255 / var(--tw-border-opacity));\n\n    --tw-border-opacity: 0.3;\n\n    background-color: rgb(241 245 249 / var(--tw-bg-opacity));\n\n    --tw-bg-opacity: 0.4;\n\n    padding: 1rem;\n\n    --tw-backdrop-blur: blur(16px);\n\n    -webkit-backdrop-filter: var(--tw-backdrop-blur) var(--tw-backdrop-brightness) var(--tw-backdrop-contrast) var(--tw-backdrop-grayscale) var(--tw-backdrop-hue-rotate) var(--tw-backdrop-invert) var(--tw-backdrop-opacity) var(--tw-backdrop-saturate) var(--tw-backdrop-sepia);\n\n            backdrop-filter: var(--tw-backdrop-blur) var(--tw-backdrop-brightness) var(--tw-backdrop-contrast) var(--tw-backdrop-grayscale) var(--tw-backdrop-hue-rotate) var(--tw-backdrop-invert) var(--tw-backdrop-opacity) var(--tw-backdrop-saturate) var(--tw-backdrop-sepia)\n}\n.site-header > .wrapper[data-v-68c30f52] {\n\n    margin: auto;\n\n    display: flex;\n\n    max-width: 72rem;\n\n    align-items: center;\n\n    justify-content: space-between\n}\n.site-logo[data-v-68c30f52] {\n\n    font-size: 1.125rem;\n\n    line-height: 1.75rem;\n\n    font-weight: 900\n}\n")();
const _sfc_main$u = {};
function _sfc_ssrRender$l(_ctx, _push, _parent, _attrs) {
  const _component_NuxtLink = __nuxt_component_0$4;
  _push(`<header${ssrRenderAttrs(mergeProps({ class: "site-header" }, _attrs))} data-v-68c30f52><div class="wrapper" data-v-68c30f52>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/",
    class: "no-underline"
  }, {
...
const plugins = normalizePlugins(_plugins);
{
  entry = async function createNuxtAppServer(ssrContext) {
    const vueApp = createApp(_sfc_main$v);
...
const InfoBox_vue_vue_type_style_index_0_scoped_true_lang = /* @__PURE__ */ (() => "\n.info-box[data-v-15157d34] {\n\n    display: flex;\n\n    align-items: flex-start;\n\n    gap: 0.5rem;\n\n    border-radius: 0.5rem;\n\n    border-width: 1px;\n\n    --tw-border-opacity: 1;\n\n    border-color: rgb(226 232 240 / var(--tw-border-opacity));\n\n    --tw-bg-opacity: 1;\n\n    background-color: rgb(241 245 249 / var(--tw-bg-opacity));\n\n    padding: 1rem;\n\n    --tw-text-opacity: 1;\n\n    color: rgb(100 116 139 / var(--tw-text-opacity))\n}\ndetails summary[data-v-15157d34] {\n\n    display: flex;\n\n    cursor: pointer;\n\n    font-weight: 600;\n\n    line-height: 1.25\n}\ndetails .details[data-v-15157d34] {\n\n    font-size: 0.875rem;\n\n    line-height: 1.25rem\n}\n.info-box .icon[data-v-15157d34] {\n\n    flex-shrink: 0\n}\n.info-box.warning[data-v-15157d34] {\n\n    --tw-border-opacity: 1;\n\n    border-color: rgb(250 204 21 / var(--tw-border-opacity));\n\n    --tw-bg-opacity: 1;\n\n    background-color: rgb(254 240 138 / var(--tw-bg-opacity));\n\n    --tw-text-opacity: 1;\n\n    color: rgb(202 138 4 / var(--tw-text-opacity))\n}\n.info-box.warning .icon.solid[data-v-15157d34] {\n\n    fill: #ca8a04\n}\n.info-box.error[data-v-15157d34] {\n\n    --tw-border-opacity: 1;\n\n    border-color: rgb(248 113 113 / var(--tw-border-opacity));\n\n    --tw-bg-opacity: 1;\n\n    background-color: rgb(254 202 202 / var(--tw-bg-opacity));\n\n    --tw-text-opacity: 1;\n\n    color: rgb(220 38 38 / var(--tw-text-opacity))\n}\n.info-box.error .icon.solid[data-v-15157d34] {\n\n    fill: #dc2626\n}\n")();
const _sfc_main$s = {
  __name: "InfoBox",
  __ssrInlineRender: true,
  props: ["type"],
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(data).article) {
        _push(`<header class="article-header" data-v-49ab34c5><div class="img-cont h-72 mb-12" data-v-49ab34c5><img${ssrRenderAttr("src", `/${unref(data).article.img}`)}${ssrRenderAttr("alt", unref(data).article.title)} class="rounded-2xl" data-v-49ab34c5></div><h1 class="heading" data-v-49ab34c5>${ssrInterpolate(unref(data).article.title)}</h1><p class="supporting" data-v-49ab34c5>${ssrInterpolate(unref(data).article.description)}</p><ul class="article-tags" data-v-49ab34c5><!--[-->`);
        ssrRenderList(unref(data).article.tags, (tag, n) => {
          _push(`<li class="tag" data-v-49ab34c5>${ssrInterpolate(tag)}</li>`);
        });
        _push(`<!--]--></ul></header>`);
      } else {
        _push(`<!---->`);
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_NuxtLink = __nuxt_component_0$4;
      _push(`<main${ssrRenderAttrs(_attrs)}><header class="page-heading"><div class="wrapper"><h1 class="text-5xl font-extrabold">All articles</h1><p class="font-medium text-lg">Here&#39;s a list of all my great articles about technical</p></div></header><section class="page-section">`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ContentList = __nuxt_component_1;
      const _component_NuxtLink = __nuxt_component_0$4;
      _push(`<main${ssrRenderAttrs(_attrs)}><header class="page-heading"><div class="wrapper"><h1 class="text-5xl font-extrabold">All articles with &quot;${ssrInterpolate(unref(slug))}&quot;</h1><p class="font-medium text-lg">Here&#39;s a list of all my great articles</p></div></header><section class="page-section">`);
      _push(ssrRenderComponent(_component_Tags, null, null, _parent));
      _push(ssrRenderComponent(_component_ContentList, {
        path: "/blog",
        query: {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_NuxtLink = __nuxt_component_0$4;
  _push(`<main${ssrRenderAttrs(_attrs)} data-v-bb61f552><section class="hero-section" data-v-bb61f552><header data-v-bb61f552><h1 class="font-black text-8xl" data-v-bb61f552>Welcome to my site</h1><p data-v-bb61f552>Take a look at `);
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/blog" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`my blog`);
